      ...
      <div class="col-md-11col-md-offset-1">
        <div class="well well-sm">
          ...
          <fieldset>
            ...
            <legend class="text-left"><h4>Canlıların Temel Bileşenleri</h4></legend>
  
                           <?php


                      $query3 = mysql_query("select n.kul_adi, n.konu from konular as k
                        inner join notlar as n on n.konu_id=k.konu_id where n.konu_id='11'");
        ...
        <div class="well well-sm">
          <form class="form-horizontal"  method="post" widht="600">
                      <fieldset>
                      <legend class="text-left"><h4>Hücre ve Organeller</h4></legend>
                      ...
                      $query3 = mysql_query("select n.kul_adi, n.konu from konular as k
                        inner join notlar as n on n.konu_id=k.konu_id where n.konu_id='12'");
                       while($list = mysql_fetch_array($query3))
                      {
                          $kul = $list['kul_adi']; 
                          $konu = $list['konu'];
