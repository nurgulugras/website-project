...
?> &nbsp
<input type="submit" onClick="parent.location='kayit.php'" value="ÇIKIŞ" class="btn btn-success pull-center">
</div>
                   </div></div>
                        <div style="  position: absolute;
    ...
    left:145px;
    top: 100px; "> 
       <h1> Din Kültürü Ve Ahlak Bilgisi</h1>
   ...
   <div style="padding: 60px;">
      <div class="col-md-11col-md-offset-1">
        <div class="well well-sm">
          ...
          <fieldset>
<legend class="text-left"><h4>Dünya Hayatı ve Ahiret</h4></legend>
  
                           <?php


                      $query3 = mysql_query("select n.kul_adi, n.konu from konular as k
                        inner join notlar as n on n.konu_id=k.konu_id where n.konu_id='17'");
        ...
        <div class="well well-sm">
          <form class="form-horizontal"  method="post" widht="600">
                      <fieldset>
                      <legend class="text-left"><h4>İslam ve Barış</h4></legend>
                      ...
                      $query3 = mysql_query("select n.kul_adi, n.konu from konular as k
                        inner join notlar as n on n.konu_id=k.konu_id where n.konu_id='18'");
                       while($list = mysql_fetch_array($query3))
                      {
                          $kul = $list['kul_adi']; 
                          $konu = $list['konu'];
