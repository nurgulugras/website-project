...
<input type="submit" onClick="parent.location='logout.php'" value="ÇIKIŞ" class="btn btn-success pull-center">
  ...
  <div class="row">
   ...
   <div style="padding: 60px;">
      <div class="col-md-6col-md-offset-6">
        <div class="well well-sm">
          <form class="form-horizontal" action="form.php" method="post" widht="600">
          <fieldset>
            <legend class="text-left"><h2>Ders Videoları</h2></legend>
            <div class="form-group">
           <div class="row">
           <div class="col-md-3">
            </div>
              <div class="col-md-9" >
               <p><h3>Sözcük Anlamı</h3></p>
